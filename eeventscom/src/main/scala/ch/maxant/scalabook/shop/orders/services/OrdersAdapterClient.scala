 ...
 * its code.
 */
private[services] trait OrdersAdapterClient {

    @Inject @Any protected var adapters : Instance[OrdersPartnerAdapter] = null

    /**
     * get the adapter for the given code.  
     */
    def getAdapter(code: String): OrdersPartnerAdapter = {
